...
namespace BruceCastro\BLApplicant\Model\ResourceModel;
use PDO;
...
class AbstractModel {
	...
	// This information should be in the module's config file.
	const 	DB_HOST = 'localhost',
			DB_USER = 'branchlabsusr',
			DB_PASS = 'branchpw',
			DB_NAME = 'branchlabsdb';
	...
	private function _initDb() {
		...
		if(!$this->_db_connection) {
			...
			try {
				$this->_db_connection = new PDO($dsn, self::DB_USER, self::DB_PASS);
